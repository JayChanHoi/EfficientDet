...
class FocalLoss(nn.Module):
    def __init__(self, alpha=0.5, gamma=2.0, smoothing_factor=0.1):
    ...
    def forward(self, classifications, regressions, anchors, annotations):
        ...
        for j in range(batch_size):
            ...
            smooth_loss = (1/2) * focal_weight * (-((1.0 - targets) * torch.log(classification) + targets * torch.log(1.0 - classification)))
            #
            cls_loss = (1.0 - self.smoothing_factor) * cls_loss + self.smoothing_factor * smooth_loss
